...
[![Docker pulls](https://img.shields.io/docker/pulls/nguyentruongtho/redsocks.svg)](https://hub.docker.com/r/nguyentruongtho/redsocks/)
...
```
docker run --privileged=true --net=host -d nguyentruongtho/redsocks 1.2.3.4 3128
```
...
docker run --privileged=true --net=host \
  ...
  -d nguyentruongtho/redsocks 1.2.3.4 3128
```
